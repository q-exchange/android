...
public class DataRepository implements DataSource {
    ...
    @Override
    public void extract(String token, String unit, String amount, String fee, String remark, String jyPassword, String address, String code, String googleCode, DataCallback dataCallback) {
        if (isLocal)
            mLocalDataSource.extract(token, unit, amount, fee, remark, jyPassword, address, code, googleCode, dataCallback);
        else
            mRemoteDataSource.extract(token, unit, amount, fee, remark, jyPassword, address, code, googleCode, dataCallback);
    }
