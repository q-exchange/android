...
import top.biduo.exchange.ui.main.trade.Coin2CoinContract;
...
public class Coin2CoinPresenter implements Coin2CoinContract.Presenter {
    ...
    public void getAddOrder(String token, String symbol, String price, String amount,
                            String direction, String type,String useDiscount,String touchPrice) {
        ...
        WonderfulOkhttpUtils.post().url(UrlFactory.getExChangeUrl()).addHeader("x-auth-token", token).addParams("symbol", symbol)
                ...
                .addParams("triggerPrice",touchPrice)
